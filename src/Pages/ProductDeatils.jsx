...
export const ProductDeatils = ({addtocart}) => {
  ...
  return (
    <>
      <section className="text-gray-100 body-font overflow-hidden px-14 bg-black">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-2/5 w-full lg:h-auto h-64 object-contain object-center rounded"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">{singledata.description}</p>
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    <select className="rounded border appearance-none border-gray-300 text-black py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded" onClick={()=>addtocart(singledata)}>
                  Add to Cart
                </button>
